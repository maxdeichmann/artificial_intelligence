...
make_test(type = 'FUNCTION_ENCODED_ARGS',
          ...
          expected_val = "List of (best_path, leaf_score, evaluation_count) corresponding to minimax score when the first player is the maximizer."+" ".join("-" for item in move_sequence(GAME1, [1,0])),
